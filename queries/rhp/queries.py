...
query_classificacao_risco = 'SELECT CD_CLASSIFICACAO_RISCO, CD_COR_REFERENCIA, CD_TRIAGEM_ATENDIMENTO, DH_CLASSIFICACAO_RISCO FROM DBAMV.VW_EXIMIO_SACR_CLASSIFICACAO_RISCO;'
