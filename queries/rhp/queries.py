...
query_classificacao_risco = "SELECT CD_CLASSIFICACAO_RISCO, CD_COR_REFERENCIA, CD_TRIAGEM_ATENDIMENTO, DH_CLASSIFICACAO_RISCO, CD_CLASSIFICACAO FROM DBAMV.VW_EXIMIO_SACR_CLASSIF_RISCO WHERE DH_CLASSIFICACAO_RISCO BETWEEN TO_DATE('{data_ini}', 'DD/MM/YYYY') AND TO_DATE('{data_fim}', 'DD/MM/YYYY')"
...
query_documento_clinico = "SELECT CD_OBJETO, cd_atendimento, cd_tipo_documento, tp_status, DH_CRIACAO FROM DBAMV.VW_EXIMIO_PW_DOCUMENTO_CLINICO WHERE DH_CRIACAO = TO_DATE('{data_ini}', 'DD/MM/YYYY') AND CD_TIPO_DOCUMENTO = 36"
...
query_tempo_processo = "SELECT DH_PROCESSO, CD_TIPO_TEMPO_PROCESSO, CD_ATENDIMENTO FROM DBAMV.VW_EXIMIO_SACR_TEMPO_PROCESSO WHERE DH_PROCESSO = TO_DATE('{data_ini}', 'DD/MM/YYYY') AND CD_TIPO_TEMPO_PROCESSO IN (1, 10, 11, 12, 21, 22, 31, 90)"
...
query_triagem_atendimento = "SELECT CD_ATENDIMENTO, CD_TRIAGEM_ATENDIMENTO, CD_SINTOMA_AVALIACAO, DS_SENHA, DH_PRE_ATENDIMENTO FROM DBAMV.VW_EXIMIO_TRIAGEM_ATENDIMENTO WHERE DH_PRE_ATENDIMENTO = TO_DATE('{data_ini}', 'DD/MM/YYYY')"

query_usuario = 'SELECT CD_USUARIO, NM_USUARIO FROM DBAMV.VW_EXIMIO_USUARIOS'

query_pre_med = "SELECT CD_PRE_MED, PM.CD_ATENDIMENTO, PM.CD_PRESTADOR, CD_DOCUMENTO_CLINICO, DT_PRE_MED, TP_PRE_MED, PM.CD_SETOR FROM DBAMV.VW_EXIMIO_PRE_MED PM WHERE DT_PRE_MED = TO_DATE('{data_ini}', 'DD/MM/YYYY')"
