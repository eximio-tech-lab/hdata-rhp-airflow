...
query_classificacao_risco = "SELECT CD_CLASSIFICACAO_RISCO, CD_COR_REFERENCIA, CD_TRIAGEM_ATENDIMENTO, DH_CLASSIFICACAO_RISCO FROM DBAMV.VW_EXIMIO_SACR_CLASS_RISCO WHERE DH_CLASSIFICACAO_RISCO BETWEEN TO_DATE('{data_ini}', 'DD/MM/YYYY') AND TO_DATE('{data_fim}', 'DD/MM/YYYY')"
