...
query_documento_clinico = "SELECT CD_OBJETO, cd_atendimento, cd_tipo_documento, tp_status, DH_CRIACAO FROM DBAMV.VW_EXIMIO_PW_DOCUMENTO_CLINICO WHERE DH_CRIACAO BETWEEN TO_DATE('{data_ini}',  'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('{data_fim}',  'YYYY-MM-DD HH24:MI:SS') AND CD_TIPO_DOCUMENTO = 36"
...
query_tempo_processo = "SELECT DH_PROCESSO, CD_TIPO_TEMPO_PROCESSO, CD_ATENDIMENTO FROM DBAMV.VW_EXIMIO_SACR_TEMPO_PROCESSO WHERE DH_PROCESSO BETWEEN TO_DATE('{data_ini}',  'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('{data_fim}',  'YYYY-MM-DD HH24:MI:SS') AND CD_TIPO_TEMPO_PROCESSO IN (1, 10, 11, 12, 21, 22, 31, 90)"
...
query_reg_fat = "SELECT CD_REG_FAT, SN_FECHADA, DT_INICIO, DT_FINAL, DT_FECHAMENTO, CD_REMESSA, VL_TOTAL_CONTA, RF.CD_ATENDIMENTO FROM DBAMV.VW_EXIMIO_REG_FAT RF WHERE DT_INICIO BETWEEN TO_DATE('{data_ini}',  'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('{data_fim}',  'YYYY-MM-DD HH24:MI:SS')"
