...
query_classificacao_risco_hdata = "SELECT CD_CLASSIFICACAO_RISCO, CD_COR_REFERENCIA, CD_TRIAGEM_ATENDIMENTO, DH_CLASSIFICACAO_RISCO FROM MV_RHP.SACR_CLASS_RISCO WHERE DH_CLASSIFICACAO_RISCO BETWEEN TO_DATE('{data_ini}',  'YYYY-MM-DD HH24:MI:SS') AND TO_DATE('{data_fim}',  'YYYY-MM-DD HH24:MI:SS')"
