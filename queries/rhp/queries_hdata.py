...
query_documento_clinico_hdata = "SELECT CD_DOCUMENTO_CLINICO, CD_OBJETO, cd_atendimento, cd_tipo_documento, tp_status, DH_CRIACAO, DH_FECHAMENTO, NM_DOCUMENTO FROM MV_RHP.PW_DOCUMENTO_CLINICO WHERE DH_CRIACAO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_CRIACAO < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"
...
query_tempo_processo_hdata = "SELECT DH_PROCESSO, CD_TIPO_TEMPO_PROCESSO, CD_ATENDIMENTO, NM_USUARIO, CD_TRIAGEM_ATENDIMENTO FROM MV_RHP.SACR_TEMPO_PROCESSO WHERE DH_PROCESSO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_PROCESSO < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"

query_tempo_processo_old_hdata = "SELECT DH_PROCESSO, CD_TIPO_TEMPO_PROCESSO, CD_ATENDIMENTO, NM_USUARIO, CD_TRIAGEM_ATENDIMENTO FROM MV_RHP.SACR_TEMPO_PROCESSO_OLD WHERE DH_PROCESSO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_PROCESSO < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"
...
query_editor_clinico_hdata = "SELECT CD_EDITOR_CLINICO, CD_DOCUMENTO_CLINICO, CD_DOCUMENTO FROM MV_RHP.PW_EDITOR_CLINICO"