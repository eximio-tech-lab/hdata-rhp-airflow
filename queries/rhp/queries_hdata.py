query_atendime_hdata = "SELECT CD_ATENDIMENTO, A.CD_MULTI_EMPRESA, CD_PACIENTE, CD_CID, CD_MOT_ALT, CD_TIP_RES, CD_CONVENIO, CD_ESPECIALID, CD_PRESTADOR, CD_ATENDIMENTO_PAI, CD_LEITO, A.CD_ORI_ATE, CD_SERVICO, TP_ATENDIMENTO, DT_ATENDIMENTO, HR_ATENDIMENTO, HR_ALTA, HR_ALTA_MEDICA, CD_TIP_MAR, CD_SINTOMA_AVALIACAO, NM_USUARIO_ALTA_MEDICA FROM MV_RHP.ATENDIME A WHERE DT_ATENDIMENTO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DT_ATENDIMENTO < TO_DATE('{data_fim}', 'DD/MM/YYYY')"
...
query_registro_alta_hdata = "SELECT CD_ATENDIMENTO, HR_ALTA_MEDICA FROM MV_RHP.PW_REGISTRO_ALTA WHERE HR_ALTA_MEDICA >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND HR_ALTA_MEDICA < TO_DATE('{data_ini}', 'DD/MM/YYYY')"
...
query_triagem_atendimento_hdata = "SELECT CD_TRIAGEM_ATENDIMENTO, CD_ATENDIMENTO, CD_SINTOMA_AVALIACAO, DS_SENHA, DH_PRE_ATENDIMENTO FROM MV_RHP.TRIAGEM_ATENDIMENTO WHERE DH_PRE_ATENDIMENTO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_PRE_ATENDIMENTO < TO_DATE('{data_ini}', 'DD/MM/YYYY')"
