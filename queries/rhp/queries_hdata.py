...
query_documento_clinico_hdata = "SELECT CD_OBJETO, cd_atendimento, cd_tipo_documento, tp_status, DH_CRIACAO FROM MV_RHP.PW_DOCUMENTO_CLINICO WHERE DH_CRIACAO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_CRIACAO < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"
...
query_tempo_processo_hdata = "SELECT DH_PROCESSO, CD_TIPO_TEMPO_PROCESSO, CD_ATENDIMENTO, NM_USUARIO FROM MV_RHP.SACR_TEMPO_PROCESSO WHERE DH_PROCESSO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_PROCESSO < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY"
...
query_tipo_tempo_processo_hdata = "SELECT CD_TIPO_TEMPO_PROCESSO, DS_TIPO_TEMPO_PROCESSO, CD_CATEGORIA_PROCESSO, DS_EXPLICACAO FROM MV_RHP.SACR_TIPO_TEMPO_PROCESS"