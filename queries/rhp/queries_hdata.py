...
query_tempo_processo_hdata = "SELECT DH_PROCESSO, CD_TIPO_TEMPO_PROCESSO, CD_ATENDIMENTO, NM_USUARIO FROM MV_RHP.TEMP_SACR_TEMPO_PROCESSO WHERE DH_PROCESSO >= TO_DATE('{data_ini}', 'DD/MM/YYYY') AND DH_PROCESSO < TO_DATE('{data_fim}', 'DD/MM/YYYY') + INTERVAL '1' DAY AND CD_TIPO_TEMPO_PROCESSO IN (1, 10, 11, 12, 21, 22, 31, 90)"
...
query_exa_rx_hdata = 'SELECT EXA_RX_CD_PRO_FAT, CD_EXA_RX, DS_EXA_RX, CD_MODALIDADE_EXAME FROM MV_RHP.TEMP_EXA_RX'
