...
def df_atendime():
    ...
    df_dim['DT_ATENDIMENTO'] = df_dim['DT_ATENDIMENTO'].fillna('0000-00-00 00:00:00')
    df_dim['HR_ATENDIMENTO'] = df_dim['HR_ATENDIMENTO'].fillna('0000-00-00 00:00:00')
    df_dim['HR_ALTA'] = df_dim['HR_ALTA'].fillna('0000-00-00 00:00:00')
    df_dim['HR_ALTA_MEDICA'] = df_dim['HR_ALTA_MEDICA'].fillna('0000-00-00 00:00:00')
