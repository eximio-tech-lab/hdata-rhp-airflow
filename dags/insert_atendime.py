...
def df_atendime():
    ...
    df_dim['DT_ATENDIMENTO'] = df_dim['DT_ATENDIMENTO'].fillna('1899-01-01 00:00:00')
    df_dim['HR_ATENDIMENTO'] = df_dim['HR_ATENDIMENTO'].fillna('1899-01-01 00:00:00')
    df_dim['HR_ALTA'] = df_dim['HR_ALTA'].fillna('1899-01-01 00:00:00')
